            ...
            imports: [config_1.ConfigModule.forRoot(),
                typeorm_1.TypeOrmModule.forRootAsync({
                    ...
                    useFactory: function (configService) { return ({
                        ...
                        entities: [user_1.User, calendar_1.Calendar, invoice_1.Invoice, message_1.Message, payment_1.Payment, sessions_1.Sessions, subplan_1.Subplan, subscription_1.Subscription], // List your entities here
